...
## 5. Output — send as a Slack message to the user
...
[2 sentences — 1 for Slack, 1 for Linear: what patterns are holding them back?]
...
Be direct. Quote real messages. Maximum 100 words.
