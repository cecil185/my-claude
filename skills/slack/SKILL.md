...
name: slack
description: >-
  Interacts with Slack workspaces via browser automation (agent-browser CLI).
  Checks unread channels, navigates Slack, sends messages, extracts data,
  searches conversations, or automates any Slack task without requiring OAuth
  or bot tokens. Trigger when user says "check my Slack", "what channels have
  unreads", "send a message to", "search Slack for", "extract from Slack",
  "find who said", or asks for any programmatic Slack interaction.
